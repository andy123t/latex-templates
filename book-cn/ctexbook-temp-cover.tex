...
\ctexset{
  chapter = {
    format = \linespread{1.0}\color{structure}\bfseries\chapfont\centering,
    nameformat = {},
    titleformat = {},
...
\ctexset{
  section = {
    format = \linespread{1.0}\color{structure}\bfseries\zihao{-3}\raggedright,
    numberformat = {},
    aftername = \quad,
    beforeskip = {24pt},
    afterskip = {6pt},
...
\ctexset{
  subsection = {
    format = \linespread{1.0}\color{structure}\bfseries\zihao{4}\raggedright,
    numberformat = {},
    aftername = \quad,
    beforeskip = {12pt},
    afterskip = {6pt},
