...
%%---------- 定义章节标题格式 ------------
\titleformat{\chapter}[hang]{\bfseries \chpzihao \filcenter}{\chpzihao \chaptername}{20pt}{}
\titlespacing{\chapter}{0pt}{-0.5ex  plus .1ex minus .2ex}{4.5ex plus .1ex minus .2ex}

\titleformat{\section}[hang]{\bfseries \zihao{3}}{\zihao{3} \thesection}{1em}{}
\titlespacing{\section}{0pt}{2.5ex plus .1ex minus .2ex}{1.0ex plus .1ex minus .2ex}

\titleformat{\subsection}[hang]{\bfseries \zihao{4}}{\zihao{4} \thesubsection}{1em}{}
...
\begin{titlepage}
  ...
  \vspace{1.25\baselineskip} % 标题上方的空白
  ...
  \vspace{0.3\baselineskip} % blank space under the publisher logo
...
这里是附录环境\index{附录环境}, 手动设置了 chapter 和 section 的样式, 并且加入到了目录.
