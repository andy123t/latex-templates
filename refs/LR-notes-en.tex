...
\noindent {\bfseries\large Paper~\twodigit{\arabic{papernum}}}\quad #1%
\par\vspace{8pt}%
\noindent\ignorespaces%
}{\par\medskip}
%--- commands of paper ---
\newcommand{\titled}[1]{\noindent{\large\color{deepblue}\sc Title:} {\bfseries #1} \par\medskip} %\hangpara{2.0em}{1}
\newcommand{\info}[2]{\noindent{\large\color{deepblue}\sc Info:} #1, {\bfseries ~#2} \par\medskip}
\renewcommand{\abstract}[1]{\noindent{\large\color{deepblue}\sc Abstract:} #1 \par\medskip}
\newcommand{\keywords}[1]{\noindent{\large\color{deepblue}\sc Keywords:} #1 \par\medskip}
\newcommand{\summary}[1]{\noindent{\large\color{deepred}\sc Summary:} #1 \par\medskip}
\newcommand{\problem}[1]{\noindent{\large\color{deepblue}\sc Problem:} #1 \par\medskip}
\newcommand{\method}[1]{\noindent{\large\color{deepblue}\sc Method:} #1 \par\medskip}
\newcommand{\intro}[1]{\noindent{\large\color{deepblue}\sc Intro:} #1 \par\medskip}
\newcommand{\conclusion}[1]{\noindent{\large\color{deepblue}\sc Conclusion:} #1 \par\medskip}
\newcommand{\note}[1]{\noindent{\large\color{deepred}\sc Note:} #1 \par\medskip}
\newcommand{\refs}[1]{\noindent{\large\color{deepblue}\sc References:} #1 \par\medskip}
