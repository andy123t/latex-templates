...
%--- command of paper ---
\newcommand{\titled}[1]{\noindent{\large\color{blue}\sc Title:} #1 \par\vspace{6pt}} %\hangpara{2.0em}{1}
\newcommand{\info}[1]{\noindent{\large\color{blue}\sc Info:} #1 \par\vspace{6pt}}
\newcommand{\abst}[1]{\noindent{\large\color{blue}\sc Abstract:} #1 \par\vspace{6pt}}
\newcommand{\keywords}[1]{\noindent{\large\color{blue}\sc Keywords:} #1 \par\vspace{6pt}}
\newcommand{\summary}[1]{\noindent{\large\color{red}\sc Summary:} #1 \par\vspace{6pt}}
\newcommand{\problem}[1]{\noindent{\large\color{blue}\sc Problem:} #1 \par\vspace{6pt}}
\newcommand{\method}[1]{\noindent{\large\color{blue}\sc Method:} #1 \par\vspace{6pt}}
\newcommand{\intro}[1]{\noindent{\large\color{blue}\sc Intro:} #1 \par\vspace{6pt}}
\newcommand{\conclusion}[1]{\noindent{\large\color{blue}\sc Conclusion:} #1 \par\vspace{6pt}}
\newcommand{\note}[1]{\noindent{\large\color{red}\sc Note:} #1 \par\vspace{6pt}}
\newcommand{\refs}[1]{\noindent{\large\color{blue}\sc References:} #1 \par\vspace{6pt}}
