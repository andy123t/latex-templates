...
\titleformat{\subsubsection}{\normalfont\slshape}{\thesubsubsection.}{1.2ex}{}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[CO]{\footnotesize\MakeUppercase{\@shorttitle}}
\fancyhead[CE]{\footnotesize\MakeUppercase{\@shortauthor}}
...
\shorttitle{A posteriori error analysis for CG methods for PDDEs}

\author[1]{Author A\thanks{Email address: \texttt{A.A@university.edu}; Corresponding author.}}
\author[1]{Author B\thanks{Email address: \texttt{B.B@university.edu}}}
\author[2]{Author C\thanks{Email address: \texttt{C.C@university.edu}}}
