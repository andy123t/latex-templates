...
\setlength{\abovecaptionskip}{2pt plus1pt minus1pt}
\setlength{\belowcaptionskip}{2pt plus1pt minus2pt}
...
%----- 定义章节样式 -----
\ctexset{%
  section/name = {,、\hspace{-1.5ex}}, %{第,节},
  section/number = \chinese{section},
  section/format = \centering, %\raggedright,
  section/nameformat = \zihao{4}\bfseries,
  section/titleformat = \zihao{4}\bfseries,
  %section/beforeskip = 5.5ex plus 1ex minus .2ex,
  % subsection
  subsection/format=\raggedright,
  subsection/nameformat=\zihao{-4}\bfseries,
  subsection/titleformat=\zihao{-4}\bfseries,
  % subsubsection
  subsubsection/format=\raggedright,
  subsubsection/nameformat=\zihao{5}\bfseries,
  subsubsection/titleformat=\zihao{5}\bfseries
}
...
两个图左右并排放置, 共用一个标题. 引用图片: 图~\ref{fig:image1}.
\begin{figure}[htp!]
\centering
...
\caption{数值误差示例.}
\label{tab:error2}
\begin{tabularx}{0.9\textwidth}{||P{1cm}|C|C|C|C|C||}
\Xhline{2\arrayrulewidth}
N  & A       & B    & C       & D      & E     \\
\Xhline{2\arrayrulewidth}
