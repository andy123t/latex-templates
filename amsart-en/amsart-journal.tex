...
\address{Address of author A}
\curraddr{Current address of author A}
\email{xyz@math.university.edu}

\author[Author B]{Author B}
\address{Address of author B}
\curraddr{Current address of author B}
\email{two@math.univ.edu}

\author[Author C]{Author C}
\address{Address of author C}
\curraddr{Current address of author C}
\email{three@univ.edu.com}

\thanks{The first author was supported in part by NSFC Grant \#000000.}
\thanks{Support information for the second author.}
\thanks{Support information for the third author.}
\thanks{The third author is the corresponding author.}
