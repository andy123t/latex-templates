...
%\setmainfont{TeX Gyre Termes}  % Open source copy of Times New Roman
%\setsansfont{TeX Gyre Heros}   % Open source copy of Helvetica
%\setmonofont{TeX Gyre Cursor}  % Open source copy of Courier New
...
\begin{table}[htp!]
\centering
\setlength{\tabcolsep}{10pt}  % 6pt standard
